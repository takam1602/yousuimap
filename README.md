...
共有プロファイルの保存には `SUPABASE_SERVICE_ROLE_KEY` と `terrain_profiles` テーブルが必要です。
Supabase SQL editor などで `supabase/migrations/20260610000000_create_terrain_profiles.sql` を適用してください。
